...
import { HelpCircle, Phone, MessageSquare, Search, Zap, Users, Calendar, DollarSign, X } from 'lucide-react';
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2">
                <div className="p-12">
                  ...
                  <p className="text-gray-300 text-lg mb-8 leading-relaxed">
                    If you couldn't find the answer you were looking for, our friendly team is here to help. Reach out and we'll get back to you right away!
                  </p>
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">Get immediate answers to your questions</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
                      <div className="bg-red-600 p-3 rounded-lg flex-shrink-0">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">Fill out our contact form anytime</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center" data-aos="fade-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/pricing">
                <Button size="lg" variant="outline" className="bg-white text-red-600 hover:bg-gray-100 border-0 text-xl px-10 py-5">
                  View Pricing
                </Button>
              </Link>
              <Link to="/events">
