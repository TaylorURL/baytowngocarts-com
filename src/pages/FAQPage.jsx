...
import {Calendar, DollarSign, HelpCircle, MessageSquare, Phone, Search, Users, X, Zap} from 'lucide-react';
        ...
        <div className="w-full -mt-20">
                ...
                <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center" data-aos="fade-up">
                        ...
                        <p className="text-xl lg:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-8">
                            Find quick answers to common questions about racing, pricing, events, and our policies
                        </p>
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden" data-aos="fade-up">
                            {filteredFAQs.length > 0 ? (
                                ...
                                <div className="p-12 text-center">
                                    ...
                                    <h3 className="text-2xl font-bold text-navy-900 mb-2">No results found</h3>
            ...
            <section className="py-24 bg-white">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto">
                        <div
                            className="bg-gradient-to-br from-navy-900 to-navy-800 rounded-2xl shadow-2xl overflow-hidden">
                            <div className="grid grid-cols-1 lg:grid-cols-2">
                                <div className="p-12">
                                    ...
                                    <p className="text-gray-300 text-lg mb-8 leading-relaxed">
                                        If you couldn't find the answer you were looking for, our friendly team is here
                                        to help. Reach out and we'll get back to you right away!
                                    </p>
                                    <div className="space-y-4">
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-400 text-sm">Get immediate answers to your
                                                    questions</p>
                                            </div>
                                        </div>
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-400 text-sm">Fill out our contact form
                                                    anytime</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div
                                    className="bg-gradient-to-br from-red-600 to-red-700 p-12 flex flex-col justify-center">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <Link to="/contact">
                                            <button
                                                className="w-full flex items-center justify-center gap-3 bg-navy-900 hover:bg-navy-800 text-white px-8 py-4 rounded-xl font-bold transition-all hover:scale-105">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center" data-aos="fade-up">
                        ...
                        <p className="text-xl text-red-100 mb-8 max-w-2xl mx-auto">
                            Now that you have your answers, come experience the thrill of Speedway 146!
                        </p>
