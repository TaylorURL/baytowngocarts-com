...
import { Shield, ShoppingBag, TrendingUp, Calendar, DollarSign, AlertCircle, CheckCircle, Clock, Eye, Search } from 'lucide-react';
...
export default function StaffPanelPage() {
  ...
  const fetchStats = async () => {
    try {
      ...
      if (revenueData) {
        totalRevenue = revenueData.reduce((sum, order) => sum + order.total_amount, 0) / 100;
        ...
        todayRevenue = todayOrders.reduce((sum, order) => sum + order.total_amount, 0) / 100;
      }
  ...
  const dateFilteredOrders = getDateFilteredOrders(activeTab === 'all' ? allOrders : filteredOrders);
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white">Staff Panel</h1>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="bg-white rounded-2xl border-2 border-gray-200 shadow-lg p-6">
                ...
                <p className="text-3xl font-bold text-navy-900">${stats.totalRevenue.toFixed(2)}</p>
              </div>
              ...
              <div className="bg-white rounded-2xl border-2 border-gray-200 shadow-lg p-6">
                ...
                <h3 className="text-gray-600 text-sm font-medium mb-1">Today's Orders</h3>
                <p className="text-3xl font-bold text-navy-900">{stats.todayOrders}</p>
              </div>
              ...
              <div className="bg-white rounded-2xl border-2 border-gray-200 shadow-lg p-6">
                ...
                <p className="text-3xl font-bold text-navy-900">${stats.todayRevenue.toFixed(2)}</p>
              </div>
            </div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b-2 border-gray-200">
                      <th className="text-left py-4 px-4 text-sm font-semibold text-gray-600">Order #</th>
