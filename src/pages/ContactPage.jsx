        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center" data-aos="fade-up">
            ...
            <p className="text-xl lg:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Have questions or ready to book? Contact us and we'll make your racing experience unforgettable
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-20">
            {contactMethods.map((method, index) => (
              ...
              >
                <div className={`${method.color === 'red' ? 'bg-red-600' : 'bg-navy-900'} w-16 h-16 rounded-xl flex items-center justify-center mx-auto mb-6 shadow-lg`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-7xl mx-auto">
            ...
            <div data-aos="fade-left">
              ...
              <p className="text-lg text-gray-600 mb-8">
                We're conveniently located in Baytown, TX. Come visit us during our business hours for an unforgettable racing experience!
              </p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2">
                <div className="bg-navy-900 text-white p-12">
                  ...
                  <div className="space-y-4">
                    {BUSINESS_HOURS.map((schedule, index) => (
                      <div key={index} className="flex justify-between items-center py-3 border-b border-white border-opacity-20">
                        <span className="font-semibold text-lg">{schedule.day}</span>
                        <span className={`${schedule.hours === 'Closed' ? 'text-red-400' : 'text-gray-300'}`}>
                          {schedule.hours}
                        </span>
                      </div>
                    ))}
                  ...
                  <div className="mt-8 p-6 bg-white bg-opacity-10 backdrop-blur-sm rounded-xl">
                    ...
                    <p className="text-sm text-gray-300">
                      Extended hours on weekends! Visit us Saturday and Sunday from 10:30 AM to 10:30 PM for all-day racing fun.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-red-600 to-red-700 text-white p-12 flex flex-col justify-center">
                  ...
                  <p className="text-red-100 mb-8 text-lg leading-relaxed">
                    Our team is ready to help you plan the perfect event. Whether it's a birthday party, corporate event, or racing league, we've got you covered.
                  </p>
                  <div className="space-y-4">
                    <a
