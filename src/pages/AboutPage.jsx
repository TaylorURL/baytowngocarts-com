...
import { Users, Award, Clock, MapPin, Zap, Shield, Heart, Target, Flag, Gauge, Calendar, Star } from 'lucide-react';
...
const AboutPage = () => {
  ...
  const features = [
    { icon: Zap, title: 'High-Speed Thrills', text: 'Professional-grade karts reaching speeds that deliver pure adrenaline' },
    { icon: Shield, title: 'Safety First', text: 'State-of-the-art safety equipment and trained staff ensure peace of mind' },
    { icon: Users, title: 'For Everyone', text: 'Activities and experiences designed for all ages and skill levels' },
    { icon: Calendar, title: 'Flexible Options', text: 'Open Thursday through Sunday with special event bookings available' },
  ];
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center" data-aos="fade-up">
            ...
            <p className="text-xl lg:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Baytown's premier destination for high-speed go-kart racing, bounce houses, and unforgettable family entertainment since 2019
            </p>
          </div>
        </div>
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <div className={`${stat.color} w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-xl`}>
                  <stat.icon className="h-10 w-10 text-white" />
                </div>
                <div className="text-4xl lg:text-5xl font-bold mb-2">{stat.value}</div>
                <div className="text-red-100 text-sm lg:text-base font-semibold tracking-wide">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div data-aos="fade-left" className="lg:order-2 order-1">
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Whether you're a first-time racer or a seasoned pro, our team is here to help you make the most of your visit and ensure you leave with a smile and memories that last a lifetime.
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center" data-aos="fade-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/pricing">
                <Button size="lg" variant="outline" className="bg-white text-red-600 hover:bg-gray-100 border-0">
                  View Pricing
                </Button>
              </Link>
              <Link to="/contact">
