...
import {Briefcase, Cake, Check, Clock, Gift, PartyPopper, Phone, Shield, Star, Trophy, Users, Zap} from 'lucide-react';
                        ...
                        {eventTypes.map((eventType, index) => (
                            ...
                            >
                                ...
                                <div className="p-8">
                                    ...
                                    <Link to="/contact">
                                        <button
                                            className="w-full bg-red-600 hover:bg-red-700 text-white py-4 rounded-xl font-bold text-lg transition-all hover:scale-105">
                                            Book Now
                                        </button>
                                    </Link>
                                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div data-aos="fade-right">
                            ...
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Our private party room is the perfect space for celebrations of all kinds. With
                                comfortable seating, decorations, and space for food and drinks, it's the ideal
                                complement to your racing experience.
                            </p>
                            <ul className="space-y-4 mb-8">
                                <li className="flex items-start text-gray-700">
                                    ...
                                    <div>
                                        <span
                                            className="font-semibold text-navy-900">Accommodates up to 30 guests</span>
                                ...
                                <li className="flex items-start text-gray-700">
                                    ...
                                    <div>
                                        <span
                                            className="font-semibold text-navy-900">Decorations and setup included</span>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {benefits.map((benefit, index) => (
                            ...
                            >
                                <div
                                    className="bg-red-100 w-16 h-16 rounded-xl flex items-center justify-center mx-auto mb-6">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center" data-aos="fade-up">
                        ...
                        <p className="text-xl text-red-100 mb-8 max-w-2xl mx-auto">
                            Contact us today to discuss your event needs. We'll create a custom package perfect for your
                            celebration!
                        </p>
                        ...
                        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6 text-left max-w-2xl mx-auto">
                            <div
                                className="bg-navy-800 bg-opacity-70 backdrop-blur-sm rounded-xl p-6 border border-white border-opacity-20">
