...
const EventsPage = () => {
  ...
  const upgrades = [
    ...
    },
    {
      ...
      price: "+$150",
      description:
        "Your group races at the same time instead of being split up",
      icon: Users,
    },
    {
      ...
      price: "+$700",
      description:
        "Exclusive use of the track — no public riders during your party",
      icon: Crown,
    },
    {
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center" data-aos="fade-up">
            ...
            <h1 className="text-5xl lg:text-7xl font-bold mb-6 text-white leading-tight">
              The Fun, <span className="text-red-500">Stress-Free</span> Way to
              Celebrate!
            </h1>
              ...
              <div className="p-8 lg:p-12">
                <div className="text-center mb-8">
                  ...
                  <div className="flex items-center justify-center gap-2">
                    <span className="text-5xl lg:text-6xl font-bold text-red-500">
                      $699
                    </span>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center" data-aos="fade-up">
            ...
            <p className="text-xl text-red-100 mb-8 max-w-2xl mx-auto">
              Ready to create an unforgettable celebration? Contact us now to
