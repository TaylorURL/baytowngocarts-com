...
const SECTIONS = [
    ...
    body: (
      <>
        ...
        <ul className="list-disc pl-6 space-y-2 marker:text-race-500">
          ...
          <li>
            <strong>Transaction Data:</strong> Records of purchases, bookings,
            event reservations, and payment history.
          </li>
          <li>
            <strong>Usage Data:</strong> Browser type, IP address, device
            information, pages visited, time spent on pages, referring URLs, and
            other analytics data.
          </li>
          <li>
            <strong>Communications:</strong> Messages, inquiries, and feedback
            you send us through contact forms, email, or other channels.
          </li>
          <li>
            <strong>Cookies and Tracking:</strong> We use cookies, web beacons,
    ...
    body: (
      <>
        ...
        <ul className="list-disc pl-6 space-y-2 marker:text-race-500">
          ...
          <li>
            Communicating with you about promotions, events, updates, and offers
          </li>
    ...
    body: (
      <>
        ...
        <ul className="list-disc pl-6 space-y-2 marker:text-race-500">
          ...
          <li>
            <strong>TaylorURL:</strong> As the website developer and operator,
            TaylorURL has full access to and rights over all data collected
            through this website, including the right to use such data for any
            lawful business purpose.
          </li>
          <li>
            <strong>Service Providers:</strong> Third-party vendors who help us
            operate our website, process payments, send communications, or
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        the purposes outlined in this policy, or as required by law. Speedway
        146 and TaylorURL reserve the right to retain data indefinitely for
        business, analytical, or archival purposes.
      </p>
    ),
  },
  {
    ...
    body: (
      <p>
        ...
        analyze usage patterns, and deliver targeted content. You may adjust
        your browser settings to refuse cookies, but some features of our
  ...
  },
  {
    ...
    body: (
      <p>
        Our services are intended for a general audience. We do not knowingly
        collect personal information from children under 13 without parental
        consent. If you believe we have collected information from a child under
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        information below. Note that Speedway 146 and TaylorURL reserve the
        right to retain and use data as permitted by applicable law.
      </p>
    ),
  },
  {
    ...
    body: (
      <p>
        ...
        Changes are effective immediately upon posting to this page. Your
