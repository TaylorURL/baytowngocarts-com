...
import {Calendar, CheckCircle, ChevronRight, Package, ShoppingBag} from 'lucide-react';
                    ...
                    <div className="max-w-4xl mx-auto text-center" data-aos="fade-up">
                        ...
                        <div className="mt-8 flex flex-wrap justify-center gap-4">
                            <div
                                ...
                                <span className="text-white font-semibold">{purchases.length} Orders</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="max-w-6xl mx-auto">
                        {purchases.length === 0 ? (
                            <div className="max-w-2xl mx-auto" data-aos="fade-up">
                                <div
                                    className="bg-white rounded-2xl border-2 border-gray-200 shadow-xl p-12 text-center">
                                    <div
                                        className="bg-gray-100 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6">
                                    ...
                                    <p className="text-gray-600 mb-8 text-lg">
                                        You haven't made any purchases yet. Browse our racing packages and book your
                                        first adventure today!
                                    </p>
                                    <button
                                    ...
                                    <div className="mt-8 pt-8 border-t border-gray-200">
                                        <h4 className="text-lg font-bold text-navy-900 mb-3">What You'll See Here</h4>
                            ...
                            <div>
                                        ...
                                        >
                                            <div
                                                        ...
                                                        <div className="flex-1">
                                                            ...
                                                            <div className="flex flex-wrap gap-4">
                                                                <div className="flex items-center gap-2 text-gray-600">
                                                                    ...
                                                                    <span
                                                                        className="text-sm">{formatDate(order.created_at)}</span>
                                                                </div>
                                                                <div
                                                ...
                                                <div className="flex items-center justify-between lg:justify-end gap-4">
                                                    ...
                                                    <div
                                                        className="bg-red-100 p-2 rounded-lg group-hover:bg-red-600 transition-colors">
                                                        <ChevronRight
                                ...
                                <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-6" data-aos="fade-up">
                                    <div
