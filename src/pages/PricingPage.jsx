...
import { Phone, Check, Zap, Users, Sparkles, Baby, TrendingUp, Download, Shield, Clock, Gift } from 'lucide-react';
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center" data-aos="fade-up">
            ...
            <p className="text-xl lg:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Affordable racing thrills and family fun for everyone. From single races to all-day excitement!
            </p>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="text-left">
                    <h3 className="text-2xl font-bold text-navy-900 mb-2">Questions About Packages?</h3>
                    <p className="text-gray-700">Need help choosing the right package? Give us a call or click "Buy Now" above!</p>
                  </div>
                </div>
                <a
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
              <div className="bg-navy-800 bg-opacity-50 backdrop-blur-md rounded-2xl p-8 border border-red-600 border-opacity-30" data-aos="fade-right">
              ...
              <div className="bg-navy-800 bg-opacity-50 backdrop-blur-md rounded-2xl p-8 border border-red-600 border-opacity-30" data-aos="fade-left">
                <div className="flex items-center gap-3 mb-6">
                  <div className="bg-red-600 p-3 rounded-xl">
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-red-500 mt-1 flex-shrink-0" />
                    <div>
                      <span className="text-gray-300">Safety equipment provided at no charge</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-red-500 mt-1 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-red-500 mt-1 flex-shrink-0" />
                    <div>
                      <span className="text-gray-300">No refunds or credits after leaving premises</span>
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="bg-gradient-to-br from-red-600 to-red-700 rounded-2xl p-8 text-center" data-aos="fade-up">
                <Gift className="h-12 w-12 mx-auto mb-4" />
                <h3 className="text-2xl font-bold mb-3">Group Discounts Available</h3>
                <p className="text-red-100 mb-6">
                  Planning a party or group event? Contact us for special pricing on party packages and group bookings!
                </p>
                <Link to="/contact">
              ...
              <div className="bg-gradient-to-br from-navy-800 to-navy-700 rounded-2xl p-8 text-center border-2 border-red-600" data-aos="fade-up" data-aos-delay="100">
                <TrendingUp className="h-12 w-12 mx-auto mb-4 text-red-500" />
                <h3 className="text-2xl font-bold mb-3">Race Swap Option</h3>
                <p className="text-gray-300 mb-6">
                  No kids in your group? Swap 3 kid races for 2 adult races at no extra charge in any Family Deal!
                </p>
                <a
                  href="tel:(346) 932-1266"
            ...
            <div className="bg-white bg-opacity-10 backdrop-blur-md rounded-2xl p-8 border border-white border-opacity-20" data-aos="fade-up">
              ...
              <p className="text-gray-300 mb-6 text-center max-w-2xl mx-auto">
                All participants must complete a waiver before racing. Download and complete before your visit for faster check-in!
              </p>
