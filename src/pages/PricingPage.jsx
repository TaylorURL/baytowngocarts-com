...
const PricingPage = () => {
  ...
  return (
    <div className="w-full -mt-20">
      ...
      <div
        className={`fixed bottom-0 left-0 right-0 z-50 bg-white border-t-4 border-red-600 shadow-2xl p-4 md:p-6 transition-transform duration-300 ${getTotalItems() > 0 ? "translate-y-0" : "translate-y-full"}`}
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Select quantities for each package you want, then add everything
              to your cart
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="text-center mb-3">
                    <div
                      className={`inline-flex p-3 rounded-xl mb-2 ${product.isPopular ? "bg-red-600" : "bg-red-100"}`}
                    >
                      <Icon
                        className={`h-5 w-5 ${product.isPopular ? "text-white" : "text-red-600"}`}
                      />
                    </div>
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Share the thrill with a passenger! Driver must be 53"+ and
              passenger 33"+
            </p>
          </div>
            ...
            {STRIPE_DOUBLE_SEATER_PRODUCTS.map((product) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-center mb-3">
                    <div
                      className={`inline-flex p-3 rounded-xl mb-2 ${product.isPopular ? "bg-red-600" : "bg-navy-900"}`}
                    >
          ...
          <div
            className="max-w-4xl mx-auto text-center my-16"
            data-aos="fade-up"
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              The fun, stress-free way to celebrate! Perfect for birthdays,
              school groups & family celebrations.
            </p>
          </div>
                    ...
                    >
                      ...
                      <div className="text-center">
                        <div className="bg-red-100 p-4 rounded-2xl inline-flex mb-4">
                          {product.name.includes("Bounce") && (
                            <PartyPopper className="h-8 w-8 text-red-600" />
                          )}
                          {product.name.includes("Race Together") && (
                            <Users className="h-8 w-8 text-red-600" />
                          )}
                          {product.name.includes("Private") && (
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Safe jumping fun for kids of all ages. Climate-controlled indoor
              excitement!
            </p>
          </div>
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
              <div
                className="bg-navy-800 bg-opacity-50 backdrop-blur-md rounded-2xl p-6 border border-red-600 border-opacity-30"
                data-aos="fade-right"
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-gray-300">
                        {" "}
                        Suggested minimum age is 5 if riding alone
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
              ...
              >
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-red-500 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-300">
                      All racing packages must be used same day
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-red-500 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-300">
                      Hair that falls below the base of the neck must be tied
                      back
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
            ...
            <div
              className="bg-navy-800 bg-opacity-70 backdrop-blur-md rounded-2xl p-6 border border-red-600 border-opacity-30"
              data-aos="fade-up"
            >
