            ...
            <div className="space-y-2">
              <div className="flex items-start space-x-3">
                ...
                <div className="text-gray-300 text-sm">
                  <div>
                    <span className="font-medium">Thursday:</span> 5:00 PM –
                    10:30 PM
                  </div>
                  <div>
                    <span className="font-medium">Friday:</span> 5:00 PM – 10:30
                    PM
                  </div>
                  <div>
                    <span className="font-medium">Saturday:</span> 10:30 AM –
                    10:30 PM
                  </div>
                  <div>
                    <span className="font-medium">Sunday:</span> 10:30 AM –
                    10:30 PM
                  </div>
                  <div>
                  ...
                  <div>
                    <span className="font-medium">Wednesday:</span> Closed
                  </div>
                </div>
              </div>
            </div>
