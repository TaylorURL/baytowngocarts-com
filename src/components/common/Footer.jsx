            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-300">
                            Baytown's go-to spot for family fun! Experience exciting go-kart racing, bounce houses, and
                            more in our welcoming environment.
                        </p>
                ...
                <div className="border-t border-navy-700 mt-8 pt-8 text-center">
                    ...
                    <p className="text-gray-400 text-sm mt-4">
                        Design by <a href="https://taylorurl.com" target="_blank" rel="noopener noreferrer"
                                     className="hover:text-red-400 transition-colors">TaylorURL.com</a>
                    </p>
                </div>
            </div>
        </footer>
