...
import { ArrowRight, Check, Zap, Baby, PartyPopper } from 'lucide-react';
          ...
          {attractions.map((attraction, index) => (
            ...
            >
              <div className="relative image-hover h-64 overflow-hidden">
                ...
                />
                <div className={`absolute top-4 right-4 ${attraction.color === 'red' ? 'bg-red-600' : 'bg-navy-900'} p-3 rounded-xl shadow-lg`}>
