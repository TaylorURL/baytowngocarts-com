...
export const FAQS = [
  {
    ...
    answer: "We are open Thursday 5:00 PM – 10:30 PM (Leagues begin at 7:30 PM — launching Q1 2026), Friday 5:00 PM – 10:30 PM, and Saturday & Sunday 10:30 AM – 10:30 PM.",
    category: "Racing"
  },
  {
  ...
  },
  {
    ...
    answer: "No reservation is needed. Walk-ins are welcome—you may purchase race tickets and wristbands at our Ticket House. However, we strongly recommend checking our social media or Google listing before visiting in case a private party or event is in progress.",
    category: "Racing"
  },
  {
    question: "What payment methods do you accept?",
    answer: "We accept cash, all major credit cards, and digital payments (depending on availability). A 4% service fee applies to card transactions. Paying with cash saves you 4%. All transactions are plus tax.",
    category: "Pricing"
  },
  {
  ...
  },
  {
    ...
    answer: "No. For safety reasons, kids race with kids and adults race with adults.",
    category: "Racing"
  },
  {
    question: "Are helmets required?",
    answer: "Helmets are optional, but available for use. You are welcome to bring your own helmet.",
    category: "Racing"
  },
  {
    question: "What should I wear to race?",
    answer: "Closed-toe shoes are highly recommended. Avoid loose clothing. Long hair must be tied back (hair ties available upon request). This is an outdoor track — expect dust and dirt; please dress accordingly.",
    category: "Racing"
  },
  {
    question: "Is racing safe for beginners?",
    answer: "Yes. Our trained team provides a full safety briefing before every ride. We also have karts geared at different speeds to accommodate all experience levels.",
    category: "Racing"
  },
  {
  ...
  },
  {
    ...
    answer: "Yes! We offer a variety of packages designed for families and groups. Visit our pricing tab for full details.",
    category: "Pricing"
  },
  {
  ...
  },
  {
    ...
    answer: "Yes. We offer 2.5 hours of unlimited riding. Time begins once the wristband is issued.",
    category: "Pricing"
  },
  {
    question: "Do you offer gift vouchers?",
    answer: "Yes! You can purchase gift vouchers at the track for an unforgettable experience.",
    category: "Pricing"
  },
  {
    question: "How do I book a private event or party?",
    answer: "To book any private event—including birthdays, family outings, corporate events, or team-building—please call (346) 932-1266.",
    category: "Events"
  },
  {
    question: "Is a deposit required for events?",
    answer: "Yes. A 20% deposit of the total balance is required to reserve your date and time.",
    category: "Events"
  },
  {
    question: "Can we bring outside food or drinks?",
    answer: "For public events, no outside food or drinks are permitted. For private events, policies vary — please call to inquire.",
    category: "Policies"
  },
  {
    question: "Do you offer catering?",
    answer: "Yes! We offer onsite catering packages for a convenient, fully handled experience. Call us for menu options and pricing.",
    category: "Events"
  },
  {
  ...
  },
  {
    ...
    answer: "A 7-business-day notice is required to receive a deposit refund. All events must also be reconfirmed 24 hours prior.",
    category: "Events"
  },
  {
    question: "Do you offer off-site bounce house rentals?",
    answer: "Yes. We offer off-site bounce house rentals and setup. Please see our Bounce House page for available units and pricing.",
    category: "Events"
  },
  {
    question: "What safety rules do riders need to follow?",
    answer: "All safety rules are clearly posted before entering the track. Failure to follow the rules may result in temporary removal, suspension, or permanent ban (if endangering others). Our professional team ensures every rider is briefed before participating.",
    category: "Policies"
  },
  {
    question: "Do you run karts in the rain?",
    answer: "In light rain, we continue operations. In heavy rain, karting is temporarily paused for safety.",
    category: "Policies"
  },
  {
    question: "Do you offer refunds for weather interruptions?",
    answer: "No refunds are issued for weather-related interruptions. Unlimited passes cannot be used on a different day.",
    category: "Policies"
  },
  {
    question: "Can race tickets be used on another day?",
    answer: "Yes — regular race tickets can be rolled over into another day if they are used within 7 days and you speak with our front desk before leaving.",
    category: "Policies"
  },
  {
    question: "Can unlimited wristbands be used another day?",
    answer: "No. Unlimited riding passes cannot roll over. If you leave the premises, your time continues running.",
    category: "Policies"
  },
  {
    question: "Do riders need to sign a waiver?",
    answer: "Yes. All riders must sign a waiver before entering the premises. Anyone under 18 must have a parent or legal guardian sign for them.",
    category: "Policies"
  },
  {
    question: "Are pets allowed?",
    answer: "Yes — as long as your pet remains leashed and you clean up after them.",
    category: "Policies"
  },
  {
    question: "What happens if a kart breaks down during a race?",
    answer: "We will safely bring you into the pit, assign you a new kart immediately (if available), and guarantee you receive your full 5 minutes of track time. If no replacement kart is available, you will be placed into the next race to complete your time.",
    category: "Racing"
  },
  {
    question: "How do I know if the track is closed for a private event?",
    answer: "Always check our social media, Google listing, or call ahead before driving down to ensure no private event is blocking public hours.",
    category: "Policies"
  }
];
